...
//    TODO iterate hash table
    ...
    hashmap_get(hashmap, "test", (void**)(&value));

    int comm_socket_fd = value->socket_fd;
    struct sockaddr_in client_addr = value->client_addr;
...
//          TODO add to hash map
            ...
            hashmap_put(data_hashmap, "test", value);
